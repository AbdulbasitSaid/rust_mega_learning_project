...
- [Year Self-Learning University — System](#year-self-learning-university--system)
...
- ### Year 1 Study guide
   ...
   **Detail:**
  Start by learning Rust, then move to Pro Git and SQL in parallel. Next, study Computer Science, then Math, and finally computer hardware concepts. Apply all Rust knowledge by building a practical project.
